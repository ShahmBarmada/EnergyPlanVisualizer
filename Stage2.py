import tkinter, re, pandas, matplotlib, os
...
inputfile = pandas.read_csv(outputPath1, delimiter=',', names=headerList, low_memory=False)
inputfile.to_csv (outputPath + '/Output.csv', index=False)
