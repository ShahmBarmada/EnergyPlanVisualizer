...
inputfile = pandas.read_csv('D:/Workspace/Projects/EnergyPlanVisualizer-Windows/ParserTests/Output1.txt', delimiter=',', names=headerList, low_memory=False)
inputfile.to_csv ('D:/Workspace/Projects/EnergyPlanVisualizer-Windows/ParserTests/Output1.csv', index=False)
#inputfile.fillna(0).to_json ('D:/Workspace/Projects/EnergyPlanVisualizer-Windows/ParserTests/Output1.json')
#inputfile.fillna(0).to_html ('D:/Workspace/Projects/EnergyPlanVisualizer-Windows/ParserTests/Output1.html')
